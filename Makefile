# This Makefile is for the nanouri extension to perl.
#
...
#     DIR => []
#     DISTNAME => q[nanouri]
#     INC => q[-Iinc/auto/Clib/include/ -Iinc -I$(INST_ARCHLIB)/auto/Clib/include/ -I/home/tokuhirom/share/cpan/lib/perl5/i686-linux/auto/Clib/include -Iinc -I$(INST_ARCHLIB)/auto/Clib/include/ -I/home/tokuhirom/share/cpan/lib/perl5/i686-linux/auto/Clib/include ]
#     LIBS => q[-L/home/tokuhirom/share/cpan/lib/perl5/i686-linux/auto/Clib/lib -L/home/tokuhirom/share/cpan/lib/perl5/i686-linux/auto/Clib/lib ]
#     NAME => q[nanouri]
#     NO_META => q[1]
#     OBJECT => q[]
...
# These definitions are from config.sh (via /usr/local/lib/perl5/5.10.1/i686-linux/Config.pm).
...
MAN3EXT = 3
INSTALLDIRS = site
INSTALL_BASE = /home/tokuhirom/share/cpan
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
PERL_LIB =
PERL_ARCHLIB = /usr/local/lib/perl5/5.10.1/i686-linux
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = /usr/local/lib/perl5/5.10.1/i686-linux/CORE
...
MAKEMAKER   = /home/tokuhirom/share/cpan/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.54
MM_REVISION = 65400
...
DLBASE = $(BASEEXT)
VERSION_FROM = 
INC = -Iinc/auto/Clib/include/ -Iinc -I$(INST_ARCHLIB)/auto/Clib/include/ -I/home/tokuhirom/share/cpan/lib/perl5/i686-linux/auto/Clib/include -Iinc -I$(INST_ARCHLIB)/auto/Clib/include/ -I/home/tokuhirom/share/cpan/lib/perl5/i686-linux/auto/Clib/include 
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Clib/nanouri.pm

PM_TO_BLIB = lib/Clib/nanouri.pm \
	blib/lib/Clib/nanouri.pm
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Clib/nanouri.pm blib/lib/Clib/nanouri.pm 
...
t/01_parse.t: t/01_parse
	$(ABSPERLRUN) -I$(INST_LIB) -e "print qq[exec q!t/01_parse! or die $!]" > t/01_parse.t

pure_all :: t/01_parse.t
	$(NOECHO) $(NOOP)
...
t/02_escape.t: t/02_escape
	$(ABSPERLRUN) -I$(INST_LIB) -e "print qq[exec q!t/02_escape! or die $!]" > t/02_escape.t

pure_all :: t/02_escape.t
	$(NOECHO) $(NOOP)
